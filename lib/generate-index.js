...
module.exports.register = (eventEmitter) => {
  ...
  const indexer = {
    ...
    doGenerateIndex: pages => {
      this.index = generateIndex(pages)
    },

    doCreateIndexFile: siteFiles => siteFiles.push(createIndexFile(this.index))
  }
}
